**Más de 72** <br/>
http://www.masde72.periodistasdeapie.org.mx/, Accessed September 22, 2018 </br>
...
Even though Más de 72 is not described as a “digital archive” by Periodistas de Pie, it has been noted how this platform serves as a repository of primary documents associated with the massacre. In this regard, I think it is important to consider how the digital humanities field can help redefine a historically politicized space created by the elite. While this is a question that still needs to be explored, we need to think: what is at stake when using the term “archive” in certain contexts? Especially in one where journalists–the authors of many of these documents–find themselves in a violent climate and are rarely protected by institutions of power. 
